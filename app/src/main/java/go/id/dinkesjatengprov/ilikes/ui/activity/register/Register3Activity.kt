...
import go.id.dinkesjatengprov.ilikes.databinding.ActivityRegister3Binding
...
class Register3Activity : BaseActivity<ActivityRegister3Binding, RegisterViewModel>(), View.OnClickListener {
...
//                    return
//                }
                startActivity(Intent(this, Register4Activity::class.java))
            }
        }
    }
