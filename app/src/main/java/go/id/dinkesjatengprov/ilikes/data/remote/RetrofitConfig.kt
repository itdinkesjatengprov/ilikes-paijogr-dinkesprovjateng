...
import go.id.dinkesjatengprov.ilikes.data.remote.interceptor.HeaderInterceptor
import go.id.dinkesjatengprov.ilikes.data.remote.interceptor.HeaderInterceptor2
...
object RetrofitConfig {
    ...
    private fun setConnection(): Retrofit {
        ...
        val okHttpClient = OkHttpClient.Builder()
            ...
            .addNetworkInterceptor(HeaderInterceptor2())
    ...
    private fun setConnection(context: Context): Retrofit {
        ...
        val unauthorizedInterceptor = UnauthorizedInterceptor(context as Activity)

        val okHttpClient = OkHttpClient.Builder()
            .addInterceptor(httpInterceptor)
            .addNetworkInterceptor(HeaderInterceptor(SharedPrefManager(context).token))
